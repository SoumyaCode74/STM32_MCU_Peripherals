...
#define DATA_BUF				 (uint8_t)0x2F

/* Private macro -------------------------------------------------------------*/

/* Private variables ---------------------------------------------------------*/
__IO uint8_t ubNbDataToTransmit     = DATA_BUF*sizeof(DATA_BUF);
__IO uint8_t ubNbDataToReceive      = DATA_BUF*sizeof(DATA_BUF);
__IO uint8_t ubButtonPress          = 0;

/**
  * @brief Variables related to MasterReceive process
  */
uint8_t      aReceiveBuffer[DATA_BUF] = {0};
...
//    if(aReceiveBuffer[ubReceiveIndex-1] == ubNbDataToTransmit)
//    {
//      /* Turn LED2 On:
