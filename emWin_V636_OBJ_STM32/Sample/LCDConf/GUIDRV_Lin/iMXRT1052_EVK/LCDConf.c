...
static void _InitController(void) {
  static U8 Done;
  U32     * pLCD_read_qos = (U32 *)0x41044100;
  ...
  if (Done == 0) {
    ...
    //
    // Increase priority of LCD master read. Default priority is 1 which causes screen
    // shifting issues.
    // Highest priority is 15. If the below priority causes issues with other peripherals it
    // could be lowered. Reference: https://community.nxp.com/t5/i-MX-RT/iMXRT1052-LCD-Screen-shifted/td-p/1069978
    //
    *pLCD_read_qos = 5;
    //
    // Init PXP
