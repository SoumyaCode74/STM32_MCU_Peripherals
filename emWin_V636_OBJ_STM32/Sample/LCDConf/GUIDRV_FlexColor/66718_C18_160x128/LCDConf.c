...
static void _WriteCommand(U16 Reg, U16 Para) {
  LCD_X_8080_16_Write00(Reg  << 1);
  LCD_X_8080_16_Write01(Para << 1);
}
#endif
...
static void _InitController(void) {
  ...
  _WriteCommand(REG_MEMORY_WRITE_MODE, 0x46);       // Reg:16h Action: 9bits dual transfer, 262K support
...
void LCD_X_Config(void) {
  ...
  //
    ...
    GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, GUIDRV_FLEXCOLOR_F66718, GUIDRV_FLEXCOLOR_M18C0B9);
    //
    // Orientation
    //
    Config.Orientation  = DISPLAY_ORIENTATION;
    Config.RegEntryMode = 0x40;
